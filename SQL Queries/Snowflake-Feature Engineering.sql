-- Fetch the first 100 rows from the HEALTH_DATA table
...
-- Create a base table with cleaned and coalesced columns
WITH BASE AS (
    SELECT 
        CASE_ID,
...
-- Select all columns from the final table with features
